  ...
  return (
    <main>
      <section className="flex flex-col items-center justify-center h-screen gap-5">
        ...
        <p className="mb-6 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">We couldn’t find the page you were looking for. Try heading back home.</p>
